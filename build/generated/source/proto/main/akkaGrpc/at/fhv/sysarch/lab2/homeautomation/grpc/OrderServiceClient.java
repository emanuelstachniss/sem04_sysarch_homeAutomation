...
public abstract class OrderServiceClient extends OrderServiceClientPowerApi implements OrderService, AkkaGrpcClient {
  ...
  protected final static class DefaultOrderServiceClient extends OrderServiceClient {
      ...
      private DefaultOrderServiceClient(GrpcChannel channel, boolean isChannelOwned, GrpcClientSettings settings, io.grpc.CallOptions options, Materializer mat, ExecutionContext ec, MetadataImpl defaultMetadata) {
        ...
        private final SingleResponseRequestBuilder<at.fhv.sysarch.lab2.homeautomation.grpc.OrderRequest, at.fhv.sysarch.lab2.homeautomation.grpc.OrderReply> orderRequestBuilder(akka.grpc.internal.InternalChannel channel){
          return new JavaUnaryRequestBuilder<>(orderDescriptor, channel, options, settings, defaultMetadata, ec);
        }
         ...
         */
        public java.util.concurrent.CompletionStage<at.fhv.sysarch.lab2.homeautomation.grpc.OrderReply> order(at.fhv.sysarch.lab2.homeautomation.grpc.OrderRequest request) {
        ...
        {
          return orderRequestBuilder(channel.internalChannel());
        }
      

      
        private static MethodDescriptor<at.fhv.sysarch.lab2.homeautomation.grpc.OrderRequest, at.fhv.sysarch.lab2.homeautomation.grpc.OrderReply> orderDescriptor =
          MethodDescriptor.<at.fhv.sysarch.lab2.homeautomation.grpc.OrderRequest, at.fhv.sysarch.lab2.homeautomation.grpc.OrderReply>newBuilder()
            .setType(
   MethodDescriptor.MethodType.UNARY 
            ...
            .setFullMethodName(MethodDescriptor.generateFullMethodName("OrderService", "order"))
            .setRequestMarshaller(new ProtoMarshaller<at.fhv.sysarch.lab2.homeautomation.grpc.OrderRequest>(OrderRequestSerializer))
            .setResponseMarshaller(new ProtoMarshaller<at.fhv.sysarch.lab2.homeautomation.grpc.OrderReply>(OrderReplySerializer))
