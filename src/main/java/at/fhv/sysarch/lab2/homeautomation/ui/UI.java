...
import at.fhv.sysarch.lab2.homeautomation.environment.*;
...
public class UI extends AbstractBehavior<Object> {
    ...
    public static Behavior<Object> create(
        ...
        return Behaviors.setup(context -> new UI(context, tempSensor, airCondition, weatherEnvironment, temperatureEnvironment, mediaStation, fridge));
    }
